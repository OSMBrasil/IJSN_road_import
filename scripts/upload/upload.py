...
#                    conn.set_debuglevel(10)
    ...
    def create_changeset(self, created_by, comment):
        ...
        ElementTree.SubElement(element, "tag", {"k": "source:url", "v": "http://www.ijsn.es.gov.br/Sitio/index.php?option=com_content&view=article&id=3780&Itemid=330"})
        ElementTree.SubElement(element, "tag", {"k": "source:highway:date", "v": "03/08/2012"})
        ElementTree.SubElement(element, "tag", {"k": "source:street:start:date", "v": "2009"})
        ElementTree.SubElement(element, "tag", {"k": "source:street:end:date", "v": "04/2013"})
